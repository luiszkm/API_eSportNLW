...
const convertMinutesToHoursString_1 = require("./utils/convertMinutesToHoursString");
...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json(ads.map((ad) => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convertMinutesToHoursString_1.convertMinutesToHoursString)(ad.hourStart), hourEnd: (0, convertMinutesToHoursString_1.convertMinutesToHoursString)(ad.hourEnd) });
    }));
}));
