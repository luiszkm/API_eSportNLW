/*
  ...
  - You are about to alter the column `hourStart` on the `Ad` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
